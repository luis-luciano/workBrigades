...
scotchApp.config(function($routeProvider) {
    $routeProvider
        ...
        .when('/', {
            templateUrl: 'assets/public/pages/home.html',
            controller: 'mainController'
        })
        .when('/dif', {
            templateUrl: 'assets/public/pages/dif.html',
            controller: 'mainController'
        })
        .when('/trade', {
            templateUrl: 'assets/public/pages/trade.html',
            controller: 'mainController'
        })
        .when('/turismAndEvents', {
            templateUrl: 'assets/public/pages/turismAndEvents.html',
            controller: 'mainController'
        })
        .when('/publicRoad', {
            templateUrl: 'assets/public/pages/publicRoad.html',
            controller: 'mainController'
        })
        .when('/environment', {
            templateUrl: 'assets/public/pages/environment.html',
            controller: 'mainController'
        })
        .when('/education', {
            templateUrl: 'assets/public/pages/education.html',
            controller: 'mainController'
        })
        .when('/services', {
            templateUrl: 'assets/public/pages/services.html',
            controller: 'mainController'
        })
        .when('/agriculturalDevelopment', {
            templateUrl: 'assets/public/pages/agriculturalDevelopment.html',
            controller: 'mainController'
        })
        .when('/civilProtection', {
            templateUrl: 'assets/public/pages/civilProtection.html',
            controller: 'mainController'
        })
        .when('/advicesAndProcedures', {
            templateUrl: 'assets/public/pages/advicesAndProcedures.html',
            controller: 'mainController'
        })
        .when('/socialDevelopment', {
            templateUrl: 'assets/public/pages/socialDevelopment.html',
            controller: 'mainController'
        })
        .when('/education', {
            templateUrl: 'assets/public/pages/education.html',
        ...
        .when('/hydrosystem', {
            templateUrl: 'assets/public/pages/hydrosystem.html',
            controller: 'mainController'
        })
        .when('/externalRelationships', {
            templateUrl: 'assets/public/pages/externalRelationships.html',
            controller: 'mainController'
        })
        .when('/supports', {
            templateUrl: 'assets/public/pages/supports.html',
            controller: 'mainController'
        })
        .when('/medicalAttention', {
            templateUrl: 'assets/public/pages/medicalAttention.html',
            controller: 'mainController'
        })
        .when('/workshopsAndTalks', {
            templateUrl: 'assets/public/pages/workshopsAndTalks.html',
            controller: 'mainController'
        })
        .when('/facilities', {
            templateUrl: 'assets/public/pages/facilities.html',
            controller: 'mainController'
        });
});

var $colors = ["rgb(0, 149, 135)", "rgb(124, 175, 66)", "rgb(86, 112, 124)", "rgb(56, 72, 162)", "rgb(161, 142, 163)", "rgb(76, 139, 8)", "rgb(193, 115, 6)", "rgb(11, 158, 91)", "rgb(79, 20, 106)", "rgb(195, 75, 71)", "rgb(29, 72, 116)", "rgb(219, 59, 48)", "rgb(226, 183, 87)"];
var $bgcolor = "rgb(0, 149, 135)";
var colorOption;
...
scotchApp.controller('mainController', function($scope) {
    ...
    var $usedColors = [$bgcolor];
    var $rand;

    $('.nopadding').each(function() {
        do {
            $rand = Math.floor(Math.random() * $colors.length);
        } while (jQuery.inArray($colors[$rand], $usedColors) !== -1);
        $usedColors.push($colors[$rand]);
        $(this).css("background-color", $colors[$rand]);
        $rounded = $(this).find('.topic').hide();
        $rounded.show().arctext({
            radius: 80,
            dir: -1
        });
    });
    ...
    if (isMobile.any()) {
        $('.nopadding').click(function() {
            $(this).find('.topic').css('opacity', '0');
            $(this).find('.info').fadeIn(0).css({
                '-ms-display': 'flex',
                'display': 'flex'
            });
            colorOption = $(this).css('background-color');

            $('.nopadding').not(this).each(function() {
                $(this).find('.info').fadeOut(0);
                $(this).find('.topic').css('opacity', '1');
            });
        });
        $('.info').click(function() {
            $bgcolor = colorOption;
        ...
        $('.nopadding').hover(function() {
            $(this).find('.topic').animate({
                opacity: 0
            });
            $(this).find('.info').fadeIn().css({
                '-ms-display': 'flex',
                'display': 'flex'
            });
        }, function() {
            $(this).find('.info').fadeOut(function() {
                $(this).parent().parent().find('.topic').animate({
                    opacity: 1
                });
            });
        });
