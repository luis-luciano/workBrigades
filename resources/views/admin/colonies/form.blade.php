    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="input-wrapper">
                  {!! Form::select('settlement_type_id', ['Indefinido', 'Congregación', 'Fraccionamiento'], null, ['class' => 'select2 form-control', 'style' => 'width: 100%']) !!}
                </div>
            </div><!--.form-group-->
        </div>
        <div class="col-md-3">
            <div class="form-group">
                ...
                <div class="input-wrapper">
                  {!! Form::select('colony_scope_id', ['Indefinido','urbano', 'rural'], null, ['class' => 'select2 form-control', 'style' => 'width: 100%']) !!}
                </div>
            </div><!--.form-group-->
        </div>
    </div>
