            ...
            <div class="result result-posts">
                ...
                <ul class="list-material">
                    <li class="has-action-left">
                        ...
                        <a href="#" class="visible">
                            <div class="list-action-left">
                                <img src="{{ asset('assets/globals/img/picjumbo/1.jpg') }}" class="img-radius" alt="">
                            </div>
                            <div class="list-content">
                    ...
                    <li class="has-action-left">
                        ...
                        <a href="#" class="visible">
                            <div class="list-action-left">
                                <img src="{{ asset('assets/globals/img/picjumbo/10.jpg') }}" class="img-radius" alt="">
                            </div>
                            <div class="list-content">
                    ...
                    <li class="has-action-left">
                        ...
                        <a href="#" class="visible">
                            <div class="list-action-left">
                                <img src="{{ asset('assets/globals/img/picjumbo/11.jpg') }}" class="img-radius" alt="">
                            </div>
                            <div class="list-content">
                    ...
                    <li class="has-action-left">
                        ...
                        <a href="#" class="visible">
                            <div class="list-action-left">
                                <img src="{{ asset('assets/globals/img/picjumbo/5.jpg') }}" class="img-radius" alt="">
                            </div>
                            <div class="list-content">
                    ...
                    <li class="has-action-left">
                        ...
                        <a href="#" class="visible">
                            <div class="list-action-left">
                                <img src="{{ asset('assets/globals/img/picjumbo/6.jpg') }}" class="img-radius" alt="">
                            </div>
                            <div class="list-content">
