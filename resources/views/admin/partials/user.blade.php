            ...
            <ul class="list-material message-list">
                <li class="has-action-left has-action-right">
                    <a href="#" class="visible" data-message-id="1">
                        <div class="list-action-left">
                            <img src="{{ asset('assets/globals/img/faces/1.jpg') }}" class="face-radius" alt="">
                        </div>
                ...
                <li class="has-action-left has-action-right">
                    <a href="#" class="visible" data-message-id="2">
                        <div class="list-action-left">
                            <img src="{{ asset('assets/globals/img/faces/10.jpg') }}" class="face-radius" alt="">
                        </div>
                        <div class="list-content">
                ...
                <li class="has-action-left has-action-right">
                    <a href="#" class="visible" data-message-id="3">
                        <div class="list-action-left">
                            <img src="{{ asset('assets/globals/img/faces/11.jpg') }}" class="face-radius" alt="">
                        </div>
                        <div class="list-content">
                ...
                <li class="has-action-left has-action-right">
                    <a href="#" class="visible" data-message-id="4">
                        <div class="list-action-left">
                            <img src="{{ asset('assets/globals/img/faces/2.jpg') }}" class="face-radius" alt="">
                        </div>
                        <div class="list-content">
                ...
                <li class="has-action-left has-action-right">
                    <a href="#" class="visible" data-message-id="5">
                        <div class="list-action-left">
                            <img src="{{ asset('assets/globals/img/faces/12.jpg') }}" class="face-radius" alt="">
                        </div>
                        <div class="list-content">
                ...
                <li class="has-action-left has-action-right">
                    <a href="#" class="visible" data-message-id="1">
                        <div class="list-action-left">
                            <img src="{{ asset('assets/globals/img/faces/13.jpg') }}" class="face-radius" alt="">
                        </div>
                        <div class="list-content">
                ...
                <li class="has-action-left has-action-right">
                    <a href="#" class="visible" data-message-id="2">
                        <div class="list-action-left">
                            <img src="{{ asset('assets/globals/img/faces/16.jpg') }}" class="face-radius" alt="">
                        </div>
                        <div class="list-content">
                ...
                <li class="has-action-left has-action-right">
                    <a href="#" class="visible" data-message-id="3">
                        <div class="list-action-left">
                            <img src="{{ asset('assets/globals/img/faces/17.jpg') }}" class="face-radius" alt="">
                        </div>
                        <div class="list-content">
            ...
            <div class="message-send-container">
                ...
                <div class="messages">
                    <div class="message left">
                        ...
                        <img src="{{ asset('assets/globals/img/faces/1.jpg') }}" class="user-picture" alt="">
                    </div>
                    <div class="message right">
                        ...
                        <img src="{{ asset('assets/globals/img/faces/tolga-ergin.jpg') }}" class="user-picture" alt="">
                    </div>
                    <div class="message left">
        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <ul class="list-material has-hidden">
                ...
                <li class="has-action-left has-action-right has-long-story">
                    ...
                    <a href="#" class="visible">
                        <div class="list-action-left">
                            <img src="{{ asset('assets/globals/img/faces/14.jpg') }}" class="face-radius" alt="">
                        </div>
                        <div class="list-content">
                            <span class="caption">Completely synergize resource sucking relationships via premier niche markets. Professionally cultivate one-to-one customer service with robust ideas.</span>
                        </div>
